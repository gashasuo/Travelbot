...
export async function getGPT3Response(location, numberOfAdults, numberOfChildren, numberOfDays) {
    try {
...
export async function saveItinerary(itinerary, location, numberOfDays, user_id) {
    try {
